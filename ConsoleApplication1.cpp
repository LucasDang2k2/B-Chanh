...
int main()
{
	...
	while (true)
	{
		system("cls");
		cout << endl << endl;
		cout << "\t\tBE YEU ANH HONG ? ";
		getline(cin, ngiu);
		if (ngiu == "co")
		{
			cout << "\t\t---ANH CUNG YEU BE LAM !---" << endl << endl;
			cout << "\t\tI LOVE U 3000..." << endl;
			Sleep(1000);
			cout << "\t\tI LOVE U 3000..." << endl; Sleep(1000);
			cout << "\t\tI LOVE U 3000..." << endl; Sleep(1000);
			cout << "\t\tI LOVE U 3000..." << endl; Sleep(1000);
			cout << "\t\tI LOVE U 3000..." << endl; Sleep(1000);
			cout << "\t\tI LOVE U 3000..." << endl; Sleep(1000);
			...
			while (true)
			{
				...
				ifstream file;
				file.open("D:/banner.txt", ios_base::in); //import file thì copy du?ng d?n r?i d?i \ thành \\ ho?c /
				string line;
				...
				ifstream file2;
				file2.open("D:/banner (1).txt", ios_base::in);
				string line2;
				...
				SetColor(A.at(i++ % A.size()));
				ifstream file3;
				file3.open("D:/banner (2).txt", ios_base::in);
				string line3;
				...
				SetColor(A.at(i++ % A.size()));
				ifstream file4;
				file4.open("D:/banner (3).txt", ios_base::in);
				string line4;
